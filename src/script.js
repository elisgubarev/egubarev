(function(){
	...
	$(window).scroll(function(){
		...
		if (scroll > caseImage1.offset().top) {
			case1.addClass("js-visible");
		}
		if (scroll > caseImage2.offset().top) {
			case2.addClass("js-visible");
		}
		if (scroll > caseImage3.offset().top) {
			case3.addClass("js-visible");
		}
	});
